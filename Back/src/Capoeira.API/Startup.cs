...
using Capoeira.Application;
using Capoeira.Application.Contratos;
using Capoeira.Persistence;
...
namespace Capoeira.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CapoeiraContext>(
            ...
            .AddEntityFrameworkStores<CapoeiraContext>()
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "Capoeira.API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Capoeira.API v1"));
            }
